...
<html lang="en">
  ...
  <body>
    <h1></h1>
 <h1 class="text-hide" style="background-image: url('img/1.1.jpg');">Bootstrap</h1>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption d-none d-md-block">
          <p><h5>Hacemos mantenimientos a las estufas<h5></p>
        </div>
      </div>
      <div class="carousel-item">
        <img src="img/1.2.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <p><h5>Instalamos y cambiamos tuberias de gas certificado<h5></p>
        </div>
      </div>
      <div class="carousel-item">
